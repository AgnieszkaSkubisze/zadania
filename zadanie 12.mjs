...
// metoda 2  - przyjmuje jeden parametry typu number, zwraca parametr - 3
// metoda 3  - przyjmuje jeden parametry typu number, zwraca parametr + 3
...
function substractThree(number1){

    let substractedNumber

    if (typeof number1 === 'number') {
        substractedNumber = number1 - 3
    }
        ...
        for (let j = 0; j < tab2.length; j++) {
            ...
            if(matchId){
                switch(tab1[i].id){
                    ...
                    break
                    case 3:
                    tab3.push({id:tab1[i].id,value:substractThree(tab1[i].value)})
                    break
                    case 5:
                    tab3.push({id:tab1[i].id,value:addThree(tab1[i].value)})
                    break
                }
            }
        }
